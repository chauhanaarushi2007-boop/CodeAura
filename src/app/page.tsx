      ...
      <section id="languages" className="w-full py-12 md:py-24 lg:py-32 bg-card/50">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 lg:gap-10">
            {languages.map((lang) => (
              <Link key={lang.id} href={`/tutorials/${lang.id}`} className="flex flex-col items-center justify-center space-y-2 group transition-transform duration-150 active:scale-95">
